...
#ifndef _IOWMIController_h
#define _IOWMIController_h
...
class IOWMIController : public IOService
	{
		OSDeclareDefaultStructors(IOWMIController)
	...
	protected:
		...
		IOReturn setEvent(const char * guid, bool state);
